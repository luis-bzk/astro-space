// To parse this data:
//
//   import { Convert, APISpaceXRes } from "./file";
//
//   const aPISpaceXRes = Convert.toAPISpaceXRes(json);
//
...
export class Convert {
  public static toAPISpaceXRes(json: string): APISpaceXRes {
    return cast(JSON.parse(json), r("APISpaceXRes"));
  }

  public static aPISpaceXResToJson(value: APISpaceXRes): string {
    return JSON.stringify(uncast(value, r("APISpaceXRes")), null, 2);
  }
}
...
const typeMap: any = {
  ...
  DatePrecision: ["hour"],
  Launchpad: ["5e9e4501f509094ba4566f84", "5e9e4502f5090995de566f86"],
